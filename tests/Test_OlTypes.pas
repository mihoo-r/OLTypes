...
type
  ...
  published
    ...
    procedure MathOperatorsCurrencyVsInteger;
  ...
  published
    procedure Arithmetic_Integer_Vs_All;
    procedure Arithmetic_All_Vs_Integer;
    procedure Arithmetic_Int64_Vs_All;
    procedure Arithmetic_All_Vs_Int64;
    procedure Arithmetic_Currency_Vs_All;
    procedure Arithmetic_All_Vs_Currency;
    procedure Arithmetic_Double_Vs_All;
    procedure Arithmetic_All_Vs_Double;

    procedure Comparison_Integer_Vs_All;
    procedure Comparison_All_Vs_Integer;
    procedure Comparison_Int64_Vs_All;
    procedure Comparison_All_Vs_Int64;
    procedure Comparison_Currency_Vs_All;
    procedure Comparison_All_Vs_Currency;
    procedure Comparison_Double_Vs_All;
    procedure Comparison_All_Vs_Double;

    procedure LogicalBitwise_Integer_Vs_All;
    procedure LogicalBitwise_All_Vs_Integer;
    procedure IncDec_Tests;
  end;
...
procedure OLStringTest.JoinedString;
var
  s: OLString;
...
begin
  ...
  Check(s = 'apple,banana,cherry');

  s := OLString.Join('', parts);
  Check(s = 'applebananacherry');
...
procedure OLCurrencyTest.MathOperatorsCurrencyVsInteger;
var
  c1, c2: OLCurrency;
  i: OLInteger;
begin
...
{ OLInteroperabilityTest }

procedure OLInteroperabilityTest.Arithmetic_Integer_Vs_All;
var
  oi: OLInteger;
  oi64: OLInt64;
  oc: OLCurrency;
...
begin
  ...
  Check(oi div i64 = 2);
  Check(oi mod i64 = 0);
  CheckEquals(2.0, oi / i64);

  // OLInteger vs OLTypes
  Check(oi + oi64 = 15);
  Check(oi - oi64 = 5);
  Check(oi * oi64 = 50);
  Check(oi div oi64 = 2);
  Check(oi mod oi64 = 0);
  CheckEquals(2.0, oi / oi64);

  Check(oc + oi = 15);

  {$IF CompilerVersion >= 36.0}
  Check(oi + oc = 15); //Internal error in Delphi XE
  {$ELSE}
  //Any of these casts solves Internal error in Delphi XE
  Check(oi + oc.AsCurrency() = 15);
  Check(oi.AsInteger() + oc= 15);
  {$IFEND}

  Check(oc - oi = -5);
  Check(oc * oi = 50);
  CheckEquals(0.5, oc / oi);

  // OLInteger vs Native (Remainder)
  Check(oi + c = 15);
  Check(oi - c = 5);
  Check(oi * c = 50);
  CheckEquals(2.0, oi / c);

  Check(oi + d = 15.0);
  Check(oi - d = 5.0);
  Check(oi * d = 50.0);
  CheckEquals(2.0, oi / d);
end;

procedure OLInteroperabilityTest.Arithmetic_All_Vs_Integer;
var
  oi: OLInteger;
  oi64: OLInt64;
  oc: OLCurrency;
...
begin
  ...
  Check(i64 div oi = 2);
  Check(i64 mod oi = 0);
  CheckEquals(2.0, i64 / oi);

  // OLTypes vs OLInteger
  Check(oi64 + oi = 15);
  Check(oi64 - oi = 5);
  Check(oi64 * oi = 50);
  Check(oi64 div oi = 2);
  Check(oi64 mod oi = 0);
  CheckEquals(2.0, oi64 / oi);

  Check(oc + oi = 15);
  Check(oc - oi = 5);
  Check(oc * oi = 50);
  CheckEquals(2.0, oc / oi);

  Check(od + oi = 15.0);
  Check(od - oi = 5.0);
  Check(od * oi = 50.0);
  CheckEquals(2.0, od / oi);

  // Native vs OLInteger (Remainder)
  Check(c + oi = 15);
  Check(c - oi = 5);
  Check(c * oi = 50);
  CheckEquals(2.0, c / oi);

  Check(d + oi = 15.0);
  Check(d - oi = 5.0);
  Check(d * oi = 50.0);
  CheckEquals(2.0, d / oi);
end;

procedure OLInteroperabilityTest.Arithmetic_Int64_Vs_All;
var
  oi64: OLInt64;
  oi: OLInteger;
  oc: OLCurrency;
...
begin
  ...
  Check(oi64 - oi = 90);
  Check(oi64 * oi = 1000);
  Check(oi64 div oi = 10);
  Check(oi64 mod oi = 0);
  CheckEquals(10.0, oi64 / oi);

  {$IF CompilerVersion >= 36.0}
  Check(oi64 + oc = 150); //Internal error in Delphi XE
  {$ELSE}
  //Any of these casts solves Internal error in Delphi XE
  Check(oi64 + oc.AsCurrency() = 150);
  Check(oi64.AsInteger() + oc= 150);
  {$IFEND}

  {$IF CompilerVersion >= 36.0}
  Check(oi64 - oc = 50); //Internal error in Delphi XE
  {$ELSE}
  //Any of these casts solves Internal error in Delphi XE
  Check(oi64 - oc.AsCurrency() = 50);
  Check(oi64.AsInteger() - oc = 50);
  {$IFEND}

  {$IF CompilerVersion >= 36.0}
  Check(oi64 * oc = 5000); //Internal error in Delphi XE
  {$ELSE}
  //Any of these casts solves Internal error in Delphi XE
  Check(oi64 * oc.AsCurrency() = 5000);
  Check(oi64.AsInteger() * oc = 5000);
  {$IFEND}

  {$IF CompilerVersion >= 36.0}
  CheckEquals(2.0, oi64 / oc);//Internal error in Delphi XE
  {$ELSE}
  //Any of these casts solves Internal error in Delphi XE
  CheckEquals(2.0, oi64 / oc.AsCurrency());
  CheckEquals(2.0, oi64.AsInteger() / oc);
  {$IFEND}
  ...
  Check(oi64 div i = 10);
  Check(oi64 mod i = 0);
  CheckEquals(10.0, oi64 / i);

  Check(oi64 + i64 = 110);
  Check(oi64 - i64 = 90);
  Check(oi64 * i64 = 1000);
  Check(oi64 div i64 = 10);
  Check(oi64 mod i64 = 0);
  CheckEquals(10.0, oi64 / i64);

  Check(oi64 + c = 110);
  Check(oi64 - c = 90);
  Check(oi64 * c = 1000);
  CheckEquals(10.0, oi64 / c);

  Check(oi64 + d = 110.0);
  Check(oi64 - d = 90.0);
  Check(oi64 * d = 1000.0);
  CheckEquals(10.0, oi64 / d);
end;

procedure OLInteroperabilityTest.Arithmetic_All_Vs_Int64;
var
  oi64: OLInt64;
  oi: OLInteger;
  oc: OLCurrency;
...
begin
  ...
  Check(oi - oi64 = 90);
  Check(oi * oi64 = 1000);
  Check(oi div oi64 = 10);
  Check(oi mod oi64 = 0);
  CheckEquals(10.0, oi / oi64);

  Check(oc + oi64 = 60);
  Check(oc - oi64 = 40);
  Check(oc * oi64 = 500);
  CheckEquals(5.0, oc / oi64);

  Check(od + oi64 = 35.0);
  Check(od - oi64 = 15.0);
  Check(od * oi64 = 250.0);
  CheckEquals(2.5, od / oi64);
  ...
  Check(i div oi64 = 10);
  Check(i mod oi64 = 0);
  CheckEquals(10.0, i / oi64);

  Check(i64 + oi64 = 110);
  Check(i64 - oi64 = 90);
  Check(i64 * oi64 = 1000);
  Check(i64 div oi64 = 10);
  Check(i64 mod oi64 = 0);
  CheckEquals(10.0, i64 / oi64);

  Check(c + oi64 = 110);
  Check(c - oi64 = 90);
  Check(c * oi64 = 1000);
  CheckEquals(10.0, c / oi64);

  Check(d + oi64 = 110.0);
  Check(d - oi64 = 90.0);
  Check(d * oi64 = 1000.0);
  CheckEquals(10.0, d / oi64);
end;

procedure OLInteroperabilityTest.Arithmetic_Currency_Vs_All;
var
  oc: OLCurrency;
  oi: OLInteger;
  oi64: OLInt64;
...
begin
  ...
  Check(oc - oi = 96);
  Check(oc * oi = 400);
  CheckEquals(25.0, oc / oi);

  Check(oc + oi64 = 105);
  Check(oc - oi64 = 95);
  Check(oc * oi64 = 500);
  CheckEquals(20.0, (oc / oi64));

  // OLCurrency vs Native
  Check(oc + i = 104);
  Check(oc - i = 96);
  Check(oc * i = 400);
  CheckEquals(25.0, oc / i);

  Check(oc + i64 = 105);
  Check(oc - i64 = 95);
  Check(oc * i64 = 500);
  CheckEquals(20.0, oc / i64);

  Check(oc + c = 104);
  Check(oc - c = 96);
  Check(oc * c = 400);
  CheckEquals(25.0, oc / c);

  Check(oc + d = 104.0);
  Check(oc - d = 96.0);
  Check(oc * d = 400.0);
  CheckEquals(25.0, oc / d);
end;

procedure OLInteroperabilityTest.Arithmetic_All_Vs_Currency;
var
  oc: OLCurrency;
  oi: OLInteger;
  oi64: OLInt64;
...
begin
  ...
  Check(oi - oc = 96);
  Check(oi * oc = 400);
  CheckEquals(25.0, oi / oc);

  Check(oi64 + oc = 104);
  Check(oi64 - oc = 96);
  Check(oi64 * oc = 400);
  CheckEquals(25.0, oi64 / oc);

  Check(od + oc = 14.0);
  Check(od - oc = 6.0);
  Check(od * oc = 40.0);
  CheckEquals(2.5, od / oc);
  {$ELSE}
  //Any of these casts solves Internal error in Delphi XE
  Check(oi.AsInteger() + oc = 104);
  Check(oi.AsInteger() - oc = 96);
  Check(oi.AsInteger() * oc = 400);
  CheckEquals(25.0, oi.AsInteger() / oc);

  Check(oi64.AsInt64() + oc = 104);
  Check(oi64.AsInt64() - oc = 96);
  Check(oi64.AsInt64() * oc = 400);
  CheckEquals(25.0, oi64.AsInt64() / oc);

  Check(od.AsDouble() + oc = 14.0);
  Check(od.AsDouble() - oc = 6.0);
  Check(od.AsDouble() * oc = 40.0);
  CheckEquals(2.5, od.AsDouble() / oc);

  Check(oi + oc.AsCurrency() = 104);
  Check(oi - oc.AsCurrency() = 96);
  Check(oi * oc.AsCurrency() = 400);

  {$IF CompilerVersion >= 36.0}
  CheckEquals(25.0, oi / oc);//Internal error in Delphi XE
  {$ELSE}
  //Any of these casts solves Internal error in Delphi XE
  CheckEquals(25.0, oi.AsInteger() / oc);
  CheckEquals(25.0, oi / oc.AsCurrency());
  {$IFEND}

  Check(oi64 + oc.AsCurrency() = 104);
  Check(oi64 - oc.AsCurrency() = 96);
  Check(oi64 * oc.AsCurrency() = 400);
  CheckEquals(25.0, oi64 / oc.AsCurrency());

  Check(od + oc.AsCurrency() = 14.0);
  Check(od - oc.AsCurrency() = 6.0);
  Check(od * oc.AsCurrency() = 40.0);
  CheckEquals(2.5, od / oc.AsCurrency());
  {$IFEND}

  // Native vs OLCurrency
  Check(i + oc = 104);
  Check(i - oc = 96);
  Check(i * oc = 400);
  CheckEquals(25.0, i / oc);

  Check(i64 + oc = 104);
  Check(i64 - oc = 96);
  Check(i64 * oc = 400);
  CheckEquals(25.0, i64 / oc);

  Check(c + oc = 104);
  Check(c - oc = 96);
  Check(c * oc = 400);
  CheckEquals(25.0, c / oc);

  Check(d + oc = 14.0);
  Check(d - oc = 6.0);
  Check(d * oc = 40.0);
  CheckEquals(2.5, d / oc);
end;

procedure OLInteroperabilityTest.Arithmetic_Double_Vs_All;
var
  od: OLDouble;
  oi: OLInteger;
  oi64: OLInt64;
...
begin
  ...
  CheckEquals(12.5, od + oi);
  CheckEquals(8.5, od - oi);
  CheckEquals(21.0, od * oi);
  CheckEquals(5.25, od / oi);

  CheckEquals(15.5, od + oi64);

  {$IF CompilerVersion >= 36.0}
  CheckEquals(30.5, od + oc);//Internal error in Delphi XE
  {$ELSE}
  //Any of these casts solves Internal error in Delphi XE
  CheckEquals(30.5, od.AsDouble() + oc);
  CheckEquals(30.5, od + oc.AsCurrency());
  {$IFEND}

  // OLDouble vs Native
  CheckEquals(12.5, od + i);
  CheckEquals(8.5, od - i);
  CheckEquals(21.0, od * i);
  CheckEquals(5.25, od / i);

  CheckEquals(15.5, od + i64);
  CheckEquals(30.5, od + c);
  CheckEquals(12.5, od + d);
end;

procedure OLInteroperabilityTest.Arithmetic_All_Vs_Double;
var
  od: OLDouble;
  oi: OLInteger;
  oi64: OLInt64;
...
begin
  ...
  CheckEquals(12.0, oi + od);
  CheckEquals(8.0, oi - od);
  CheckEquals(20.0, oi * od);
  CheckEquals(5.0, oi / od);

  CheckEquals(22.0, oi64 + od);
  CheckEquals(52.0, oc + od);

  // Native vs OLDouble
  CheckEquals(12.0, i + od);
  CheckEquals(8.0, i - od);
  CheckEquals(20.0, i * od);
  CheckEquals(5.0, i / od);

  CheckEquals(22.0, i64 + od);
  CheckEquals(52.0, c + od);
  CheckEquals(12.0, d + od);
end;

procedure OLInteroperabilityTest.Comparison_Integer_Vs_All;
var
  oi: OLInteger;
  oi64: OLInt64;
  oc: OLCurrency;
...
begin
  ...
  {$IF CompilerVersion >= 36.0}
  Check(oi = oc);//Internal error in Delphi XE
  {$ELSE}
  //Any of these casts solves Internal error in Delphi XE
  Check(oi.AsInteger() = oc);
  Check(oi = oc.AsCurrency());
  {$IFEND}
  ...
  {$IF CompilerVersion >= 36.0}
  Check(oi > oc - 1);//Internal error in Delphi XE
  {$ELSE}
  //Any of these casts solves Internal error in Delphi XE
  Check(oi.AsInteger() > oc - 1);
  Check(oi > oc.AsCurrency() - 1);
  {$IFEND}
...
procedure OLInteroperabilityTest.Comparison_All_Vs_Integer;
var
  oi: OLInteger;
  oi64: OLInt64;
  oc: OLCurrency;
...
procedure OLInteroperabilityTest.Comparison_Int64_Vs_All;
var
  oi64: OLInt64;
  oc: OLCurrency;
  i: Integer;
...
begin
  ...
  {$IF CompilerVersion >= 36.0}
  Check(oi64 = oc);//Internal error in Delphi XE
  {$ELSE}
  //Any of these casts solves Internal error in Delphi XE
  Check(oi64.AsInt64() = oc);
  Check(oi64 = oc.AsCurrency());
  {$IFEND}
  ...
  // Cross-type
  Check(oi64 > OLInteger(400));

  {$IF CompilerVersion >= 36.0}
  Check(oi64 < OLCurrency(600));//Internal error in Delphi XE
  {$ELSE}
  //Type cast solves Internal error in Delphi XE
  Check(oi64.AsInt64() < OLCurrency(600));
  {$IFEND}

  Check(oi64 = OLDouble(500.0));
...
procedure OLInteroperabilityTest.Comparison_All_Vs_Int64;
var
  oi64: OLInt64;
  oi: OLInteger;
  oc: OLCurrency;
...
begin
  ...
  Check(oi = oi64);
  Check(OLCurrency(600) > oi64);
  Check(OLDouble(500.0) = oi64);
...
procedure OLInteroperabilityTest.Comparison_Currency_Vs_All;
var
  oc: OLCurrency;
  od: OLDouble;
  i: Integer;
...
begin
  ...
  {$IF CompilerVersion >= 36.0}
  Check(oc = od);//Internal error in Delphi XE
  {$ELSE}
  //Any of these casts solves Internal error in Delphi XE
  Check(oc.AsCurrency() = od);
  Check(oc = od.AsDouble());
  {$IFEND}
  ...
  // Cross-type
  Check(oc > OLInteger(100));
  Check(oc < OLInt64(200));
...
procedure OLInteroperabilityTest.Comparison_All_Vs_Currency;
var
  oc: OLCurrency;
  oi: OLInteger;
  od: OLDouble;
...
begin
  ...
  {$IF CompilerVersion >= 36.0}
  Check(od = oc);//Internal error in Delphi XE
  {$ELSE}
  //Any of these casts solves Internal error in Delphi XE
  Check(od.AsDouble() = oc);
  Check(od = oc.AsCurrency());
  {$IFEND}
...
procedure OLInteroperabilityTest.Comparison_Double_Vs_All;
var
  od: OLDouble;
  oi: OLInteger;
  i: Integer;
...
begin
  ...
  {$IF CompilerVersion >= 36.0}
  Check(od < OLCurrency(150));//Internal error in Delphi XE
  {$ELSE}
  //Type cast solves Internal error in Delphi XE
  Check(od.AsDouble() < OLCurrency(150));
  {$IFEND}
...
procedure OLInteroperabilityTest.Comparison_All_Vs_Double;
var
  od: OLDouble;
  oi: OLInteger;
  i: Integer;
...
procedure OLInteroperabilityTest.LogicalBitwise_Integer_Vs_All;
var
  oi1, oi2: OLInteger;
  i: Integer;
begin
  ...
  Check((oi1 or oi2) = $FFFF);
  Check((oi1 and oi1) = $FF00);
  Check((oi1 xor oi2) = $FFFF);
  Check(not(OLInteger(0)) = -1);
...
procedure OLInteroperabilityTest.LogicalBitwise_All_Vs_Integer;
var
  oi1, oi2: OLInteger;
  i: Integer;
begin
  ...
  Check(($FFFF = (oi1 or oi2)));
  Check(($FF00 = (oi1 and oi1)));
  Check(($FFFF = (oi1 xor oi2)));
...
procedure OLInteroperabilityTest.IncDec_Tests;
var
  oi: OLInteger;
  oi64: OLInt64;
  od: OLDouble;
